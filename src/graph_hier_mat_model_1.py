...
from .sent_att_model_1 import SentAttNet
from .word_att_model_1 import WordAttNet
import torch.nn.functional as F

class HierGraphNet(nn.Module):
    def __init__(self, word_hidden_size, sent_hidden_size, batch_size, vocab,
        ...
        self.word_att_net = WordAttNet(vocab, word_hidden_size)
